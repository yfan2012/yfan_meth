...
def parseArgs():
    ...
    parser.add_argument('-q', '--mapq', type=int, required=False, help='min mapq if filtering')
    parser.add_argument('-l', '--minlen', type=int, required=False, help='minimium read length if filtering')
    parser.add_argument('-n', '--nummotifs', type=int, required=False, help='minimum nmber of motifs if filtering')
